...
class $ProductsTable extends Products with TableInfo<$ProductsTable, Product> {
  ...
  late final GeneratedColumn<int> currentStock = GeneratedColumn<int>(
    ...
    aliasedName,
    false,
    check: () => ComparableExpr(currentStock).isBiggerOrEqualValue(0),
    type: DriftSqlType.int,
...
final class $$UsersTableReferences
  ...
  static MultiTypedResultKey<$ProductsTable, List<Product>> _productsRefsTable(
    ...
    db.products,
    aliasName: 'users__id__products__user_id',
  );
    ...
    : super(
        TableManagerState(
          ...
          updateCompanionCallback:
              ...
              }) => UsersCompanion(id: id, name: name, rowid: rowid),
          createCompanionCallback:
              ({
                required String id,
                required String name,
                Value<int> rowid = const Value.absent(),
              }) => UsersCompanion.insert(id: id, name: name, rowid: rowid),
          ...
          prefetchHooksCallback:
              ({productsRefs = false, inventoryMovementsRefs = false}) {
...
typedef $$UsersTableProcessedTableManager =
    ProcessedTableManager<
      ...
      (User, $$UsersTableReferences),
      User,
      PrefetchHooks Function({bool productsRefs, bool inventoryMovementsRefs})
    >;
...
final class $$ProductsTableReferences
  ...
  static $UsersTable _userIdTable(_$AppDatabase db) =>
      db.users.createAlias('products__user_id__users__id');
